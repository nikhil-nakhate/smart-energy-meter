...
#define HAL_SPI_SS_ON()                    st( P5OUT &= 0xFE; )
#define HAL_SPI_SS_OFF()                   st( P5OUT |= 0x01; )

#define HAL_SPI_WRITE_BYTE(X)              st( UC1IFG &= ~UCB1RXIFG;  UCB1TXBUF = (X); )
#define HAL_SPI_READ_BYTE()                UCB1RXBUF
#define HAL_SPI_WAIT_DONE()                while(!(UC1IFG & UCB1RXIFG));
